...
INCOMPLETE_PAYMENT_TEXT = (
    "Вы не завершили оформление доступа в АвтоКлуб НСК 🚗\n\n"
    "Напоминаю:\n"
    "— скидки на автоуслуги\n"
    "— участие в розыгрышах\n"
    "— закрытый клуб\n\n"
    "Стоимость: 349 ₽ / месяц\n\n"
    "Нажмите «Как оплатить» и завершите оформление доступа"
)

PAYMENT_RECEIVED_WAITING_TEXT = (
    "Мы получили ваш платёж ✅\n\n"
    "Администратор скоро проверит оплату и выдаст доступ.\n"
    "Если долго нет ответа — напишите «оператор»"
)

ACCESS_EXPIRES_SOON_TEXT = (
    "Ваш доступ в АвтоКлуб НСК скоро закончится ⚠️\n\n"
    "Продлите доступ, чтобы не потерять:\n"
    "— скидки\n"
    "— участие в розыгрыше\n\n"
...
ACCESS_EXPIRED_TEXT = (
    "Ваш доступ в АвтоКлуб НСК закончился ❌\n\n"
    "Вы больше не получаете:\n"
    "— скидки\n"
    "— участие в розыгрышах\n\n"
    "Верните доступ за 349 ₽"
)
